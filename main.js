...
const scenes = {
    "start" : new Scene("assets/bg/conan.jpg", "assets/audio/chill.mp3", [
        haibara
    ], [
        new Dialogue(haibara, "Hello there!", null, "neutral"),
        new Dialogue(haibara, "My name is <b>Haibara Ai</b>!", null, "neutral"),
        new Dialogue(haibara, "Nice to meet you!", null, "neutral"),
        new Dialogue(haibara, "You must be new here, ", null, "neutral"),
        new Dialogue(haibara, "Let me take you to a tour, ", null, "neutral"),
        new Dialogue(haibara, "Follow me!", null, "neutral"),
        new Dialogue(haibara, " ", null, "neutral", "MouriAgency"),
    ]),
    "MouriAgency" : new Scene("assets/bg/mouri.jpg", "assets/audio/tense.mp3", [
        haibara,
        null,
        null,
        null
    ],[
        new Dialogue(haibara, "This is the Mouri Detective Agency!", null, "neutral"),
        new Dialogue(haibara, "Mr. Kogoro lives here along with his daughter Ran, ", null, "neutral"),
        new Dialogue(haibara, "Conan also lives here!", null, "neutral"),
        new Dialogue(haibara, "Where do you wanna go now?, ", 
            new Choice([{
                "text" : "Go back",
                "outcome" : () => {changeNextScene("start")}
            }, {
                "text" : "Stay here",
